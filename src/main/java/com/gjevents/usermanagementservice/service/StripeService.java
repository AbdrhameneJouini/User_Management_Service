...
public class StripeService {
	...
	public StripeService(MailSenderService mailSenderService) {
	...
	public void sendEmail(String email, String eventId, String total, String chargeId) {
		String subject = "Payment Confirmation for Event ID: " + eventId;
		String body = "Dear Customer,\n\n" +
				"Thank you for your payment. Your payment details are as follows:\n" +
